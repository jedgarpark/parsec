...
try:
    ...
    print("Showing splash screen for 10 seconds...")
    time.sleep(4)
    print("Starting game!")
...
# Create score label at top of screen  
score_text = label.Label(
    terminalio.FONT, text=f"SCORE: {score}", color=black, x=10, y=17, scale=3
)
...
alien_width = 18  # Halfway between 12 and 24
alien_height = 13  # Halfway between 9 and 18 (rounded down)
alien_cols = 11
alien_rows = 5
alien_spacing_x = 9  # Halfway between 6 and 12
alien_spacing_y = 9  # Halfway between 6 and 12
